                ...
                <el-col :span="19">
                    ...
                    <div style="display: flex;">
                        <div class="project-header-item header-blur-container">
                            <span class="project-header-item-text">项目创建于 | {{ projectInfo.createDate }}</span>
                            <MiniUserCard :userInfo="creatingUser"></MiniUserCard>
                        </div>
                        <div class="project-header-item header-blur-container">
                            <span class="project-header-item-text">最后修改于 | {{ projectInfo.modifyDate }}</span>
    ...
    data() {
        return {
            projectInfo: {
                ...
                projectName: '吃饭',
                projectIntro: '睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉睡觉',

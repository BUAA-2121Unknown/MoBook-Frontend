...
import { onBeforeUnmount, ref, toRefs, onMounted } from 'vue';
...
editor.value = new Editor({
  content: content.value.length == 0 ? {} : JSON.parse(content.value),
  extensions: [

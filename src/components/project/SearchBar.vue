...
<template>
    <div class="bar-container">
        <input class="input-area" type="search" v-model="input" placeholder="输入关键字检索已有文档" @keyup.enter="handleSearch" />
...
export default {
    ...
    methods: {
        // 以输入关键字作为参数跳转到搜索页面 在搜索页面再根据输入的关键字进行搜索
        handleSearch() {
            if (!this.input) {

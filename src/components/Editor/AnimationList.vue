  ...
  <div class="animation-list">
    <div class="div-animation">
      ...
      <div>
        ...
        >
          {{ tag.label }}
          <el-icon class="cursor"><el-icon-setting /></el-icon>
        </el-tag>
      </div>
    </div>
...
import animationClassData from '../../utils/design/animationClassData'
...
export default {
  ...
  emits: ['runAnimation', 'stopAnimation'],
}
</script>

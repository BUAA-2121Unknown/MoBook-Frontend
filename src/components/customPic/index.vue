<template>
  <span class="headerAvatar">
    <template v-if="picType === 'avatar'">
      <el-avatar v-if="userStore.userInfo.avatarUrl" :size="30" :src="userStore.userInfo.avatarUrl" />
...
const avatar = computed(() => {
  if (props.picSrc === '') {
    if (userStore.userInfo.avatarUrl !== '' && userStore.userInfo.avatarUrl.slice(0, 4) === 'http') {
      return userStore.userInfo.avatarUrl
    }
    return path.value + userStore.userInfo.avatarUrl
  } else {
